  ...
  <div className="min-h-screen">
    ...
    <footer className="bg-surface-darker px-5 py-8 text-center text-xs text-primary-foreground/20">
      ...
      <div className="flex items-center justify-center gap-4 my-4">
        <a href="#" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Skool" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
