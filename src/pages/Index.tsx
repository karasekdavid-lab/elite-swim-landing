  ...
  <div className="min-h-screen">
    ...
    <footer className="bg-surface-darker px-5 py-8 text-center text-xs text-primary-foreground/20">
      ...
      <div className="flex items-center justify-center gap-4 my-4">
        ...
        <a href="https://www.instagram.com/myswimpros/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="https://www.facebook.com/myswimpros" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="https://www.tiktok.com/@myswimpros" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="https://www.linkedin.com/in/davidraphaelkarasek/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
        ...
        <a href="https://www.skool.com/mindgympro" target="_blank" rel="noopener noreferrer" aria-label="Skool" className="text-primary-foreground/40 hover:text-primary-foreground/70 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zm4.5 11.5h-9v-1c0-2 4-3.1 4.5-3.1s4.5 1.1 4.5 3.1v1z"/></svg>
        </a>
      </div>
