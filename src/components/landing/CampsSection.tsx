const camps = [
  { name: "Summer Camp 1", dates: "Aug 4 – 14", year: "2026", tag: "FILLING FAST", tagColor: "destructive" as const, highlight: "", emoji: "☀️", season: "summer", vibe: "Golden sunshine & long pool days" },
  { name: "Summer Camp 2", dates: "Aug 17 – 27", year: "2026", tag: "FILLING FAST", tagColor: "destructive" as const, highlight: "⭐ Guest coaches: WR holders Peter Mankoč & Milorad Čavić — all 10 days", emoji: "🌊", season: "summer", vibe: "Peak summer performance" },
